...
/// Ark app bar with consistent styling and overflow handling
/// Supports custom title, back button, and actions
class ArkAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  State<ArkAppBar> createState() => _ArkAppBarState();

  @override
  Size get preferredSize => const Size.fromHeight(kToolbarHeight);
}

class _ArkAppBarState extends State<ArkAppBar> {
