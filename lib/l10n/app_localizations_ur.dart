...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get useYourSecretKeyToAccessYourWallet => 'اپنی خفیہ کلید سے والیٹ تک رسائی حاصل کریں';
  ...
  @override
  String get pleaseEnterBothAddressAndAmount => 'براہ کرم پتہ اور رقم دونوں درج کریں';
  ...
  @override
  String get esploraUrlSavedWillOnlyTakeEffectAfterARestart => 'Esplora URL محفوظ ہو گیا - دوبارہ شروع کرنے کے بعد مؤثر ہوگا';

  @override
  String get failedToSaveEsploraUrl => 'Esplora URL محفوظ کرنے میں ناکامی';

  @override
  String get networkSavedWillOnlyTakeEffectAfterARestart => 'نیٹ ورک محفوظ ہو گیا - دوبارہ شروع کرنے کے بعد مؤثر ہوگا';

  @override
  String get arkServerUrlSavedWillOnlyTakeEffectAfterARestart => 'Ark سرور URL محفوظ ہو گیا - دوبارہ شروع کرنے کے بعد مؤثر ہوگا';

  @override
  String get failedToSaveArkServerUrl => 'Ark سرور URL محفوظ کرنے میں ناکامی';

  @override
  String get boltzUrlSavedWillOnlyTakeEffectAfterARestart => 'Boltz URL محفوظ ہو گیا - دوبارہ شروع کرنے کے بعد مؤثر ہوگا';
  ...
  @override
  String get neverShareYourRecoveryKeyWithAnyone => 'اپنی بحالی کلید کسی کے ساتھ شیئر نہ کریں!';

  @override
  String get anyoneWithThisKeyCan => 'جس کے پاس یہ کلید ہوگی وہ آپ کے والیٹ تک رسائی حاصل کر سکتا ہے اور رقم چرا سکتا ہے۔ اسے محفوظ جگہ پر رکھیں۔';
  ...
  @override
  String get recoveryPhraseCopiedToClipboard => 'بحالی فقرہ کلپ بورڈ پر کاپی ہو گیا';
  ...
  @override
  String get thisWillDeleteAllWalletData => 'اس سے اس آلہ سے تمام والیٹ ڈیٹا حذف ہو جائے گا۔ جاری رکھنے سے پہلے اپنا بحالی فقرہ محفوظ کر لیں۔ یہ عمل واپس نہیں ہو سکتا۔';

  @override
  String get restartingApp => 'ایپ دوبارہ شروع ہو رہی ہے';

  @override
  String get pleaseTapHereToOpenTheAppAgain => 'ایپ دوبارہ کھولنے کے لیے یہاں ٹیپ کریں۔';
  ...
  @override
  String get backupYourWalletWithTheseKey => 'ان کلیدوں سے اپنا والیٹ بیک اپ کریں';
  ...
  @override
  String get deleteAllWalletDataFromThisDevice => 'اس آلے سے تمام والیٹ ڈیٹا حذف کریں';
  ...
  @override
  String get transactionSettledSuccessfully => 'ٹرانزیکشن کامیابی سے مکمل ہو گئی!';
  ...
  @override
  String get transactionPendingFundsWillBeNonReversibleAfterSettlement => 'ٹرانزیکشن زیر التواء ہے۔ مکمل ہونے کے بعد رقم واپس نہیں کی جا سکے گی۔';
  ...
  @override
  String get returningToWalletAfterSuccessfulTransaction => 'کامیاب ٹرانزیکشن کے بعد والیٹ پر واپس جا رہے ہیں';
  ...
  @override
  String get signInToViewContracts => 'اپنے معاہدے دیکھنے اور قرض لینے کے لیے سائن ان کریں۔';

  @override
  String get noArkadeOffersAvailable => 'کوئی Arkade پیشکش دستیاب نہیں';

  @override
  String get signInToViewYourContracts => 'اپنے معاہدے دیکھنے کے لیے سائن ان کریں';

  @override
  String get noContractsMatchSearch => 'کوئی معاہدہ آپ کی تلاش سے مماثل نہیں';

  @override
  String get noContractsYet => 'ابھی کوئی معاہدہ نہیں۔ شروع کرنے کے لیے پیشکش قبول کریں!';
